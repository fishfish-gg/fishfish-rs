...
pub struct CreateDomainEndpoint {
    #[serde(skip)]
    pub domain: String,
...
impl Endpoint for CreateDomainEndpoint {
    ...
    fn body(&self) -> Result<Option<Body>, FishFishError> {
        if self.category == DomainCategory::Unknown {
            // TODO: prevent this
        }
...
#[async_trait(?Send)]
impl AuthWebRequest<Domain> for CreateDomainEndpoint {}